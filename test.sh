...
gcc -g -o interpreter_test.exe src/interpreter_test.c src/interpreter.c src/scanner.c src/editor.c src/variables.c src/stack.c -I ./include && ./interpreter_test.exe