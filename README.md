...
An attempt to make an interactive mode [Tiny Basic](https://en.wikipedia.org/wiki/Tiny_BASIC) compiler in C.  
...
Numbers are limited to 16-bit integers.  Mathematical operators are `+`, `-`, `*`, and `/` (integer division of course).  
